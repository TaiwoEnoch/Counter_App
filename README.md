...
**Counter App** Counter App is an App that make counting easy and reliable for anyone.
...
On the terminal run this command git clone https://github.com/TaiwoEnoch/Counter_App.git

once you clone the Repository you can go live on it direct by navigating your way through chrome or any other web browser to access the live demo of the app. 
...
I would like to thank to appreciate Scrimba for opportunity and privilege for creating such a platform for easy learning.
